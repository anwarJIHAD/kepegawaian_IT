				...
				<div class="card-body">
					<div style="margin-bottom: 20px;">
						<?php if ($pegawai['role'] == 'Admin') { ?>
							...
							<a href="<?= base_url() ?>Lembur/export" class="btn btn-outline-warning"><i class="bi bi-plus-circle"></i> Export Excel</a>
						<?php } ?>
					</div>
									...
									<tr>
										...
										<td>
											<?php if (
												...
												<a href="<?= base_url('Lembur/hapus/') . $us['id_lembur']; ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Hapus</a>
