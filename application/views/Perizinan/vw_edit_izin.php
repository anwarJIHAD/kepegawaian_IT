            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  ...
                  <?php if ($izin['tujuan_izin'] != 'Tidak Hadir ke Sekolah' && $izin['tujuan_izin'] != 'Terlambat Hadir ke Sekolah' && $izin['tujuan_izin'] != 'Izin Keluar' && $izin['tujuan_izin'] != 'Pulang Cepat' && $izin['tujuan_izin'] != 'Terlambat Hadir Rapat' && $izin['tujuan_izin'] != 'Tidak Ikut Rapat' ){ ?>
    <input type="text" class="form-control" id="other_input" name="other_input" value="<?= $izin['tujuan_izin'] ?>"/>
<?php } ?>
